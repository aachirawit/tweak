...
#define WAVEFORM_SCALE_WAS_DRAWN_TO_X_OFFSET (WAVEFORM_VARIABLES_COUNT + WAVEFORM_VARIABLES_X_OFFSET)
...
#define CIE_DIAGRAM_VARIABLES_X_OFFSET (WAVEFORM_SCALE_WAS_DRAWN_TO_COUNT + WAVEFORM_SCALE_WAS_DRAWN_TO_X_OFFSET)
