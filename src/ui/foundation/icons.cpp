...
void draw(id which, ImDrawList* dl, const ImVec2& tl, float box, ImU32 col)
{
    ...
    case id::gamepad:
        // lucide gamepad-2. The two face buttons are drawn as small circles
        // rather than lucide's zero-length dot segments, which a stroked path
        // renders as nothing at all.
        path("M6 11h4");
        path("M8 9v4");
        path("M15 11.1a0.9 0.9 0 1 0 0 1.8a0.9 0.9 0 1 0 0-1.8");
        path("M18 9.1a0.9 0.9 0 1 0 0 1.8a0.9 0.9 0 1 0 0-1.8");
        path("M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 "
             "2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.414-1.414A2 2 0 0 1 9.828 16h4.344a2 2 0 0 1 "
