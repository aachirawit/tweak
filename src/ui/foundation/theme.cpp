...
constexpr palette k_light{
    ...
    IM_COL32(0x65, 0x67, 0x6D, 0xFF), IM_COL32(0x17, 0x18, 0x1B, 0x14),
    IM_COL32(0x17, 0x18, 0x1B, 0x26),
...
constexpr palette k_dark{
    ...
    IM_COL32(0x8A, 0x8C, 0x91, 0xFF), IM_COL32(0xFF, 0xFF, 0xFF, 0x12),
    IM_COL32(0xFF, 0xFF, 0xFF, 0x21),
