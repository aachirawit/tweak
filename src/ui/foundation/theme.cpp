...
struct palette
{
    ...
    ImU32 muted_foreground, dim_foreground;
...
constexpr palette k_light{
    ...
    IM_COL32(0x6B, 0x6E, 0x74, 0xFF), IM_COL32(0x9A, 0x9D, 0xA3, 0xFF),
...
constexpr palette k_dark{
    ...
    IM_COL32(0x8A, 0x8C, 0x91, 0xFF), IM_COL32(0x5E, 0x61, 0x67, 0xFF),
...
void set_dark(bool dark)
{
    ...
    c_dim_foreground = p.dim_foreground;
    c_border = p.border;
